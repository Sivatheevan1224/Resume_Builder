...
const Testimonial = () => {
  ...
  return (
    <div id='testimonials' className='flex flex-col items-center my-10  scrool-mt-12'>
        ...
        <Title title="Don't just take our word for it" description="Hear from our satisfied users who have successfully built their resumes with our intuitive builder. We're always here to support you.if you have any questions or need assistance, feel free to reach out."/>
