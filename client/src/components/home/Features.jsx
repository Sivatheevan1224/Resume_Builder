...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10  scrool-mt-12'>
        ...
        <Title title="Build your Resume" description="Create a professional resume with ease using our intuitive builder."/>
